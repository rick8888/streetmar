<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('scoot');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('scoot');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('scoot');
?>
