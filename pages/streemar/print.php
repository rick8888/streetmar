<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('print');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('print');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('print');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Impression<em class="small"> le leader dans ce domaine </em></h3></div>
