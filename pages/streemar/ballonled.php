<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('ballon');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('ballon');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('ballon');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Ballon Led <em class="small"> le leader dans ce domaine </em></h3></div>
