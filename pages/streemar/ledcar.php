<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('ledcar');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('ledcar');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('ledcar');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Led's Car <em class="small"> le leader dans ce domaine </em></h3></div>
