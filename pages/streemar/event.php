<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('event');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('event');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('event');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Evenementiel <em class="small"> le leader dans ce domaine </em></h3></div>
