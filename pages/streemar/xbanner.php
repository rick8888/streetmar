<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('xbanner');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('xbanner');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('xbanner');
    foreach($imgs as $img)
    {
      var_dump($img->nom, $img->image);  
    }
...
?>
    ...
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Xbanner<em class="small"> le leader dans ce domaine </em></h3></div>
