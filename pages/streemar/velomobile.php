<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('velo');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('velo');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('velo');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Velo Mobile <em class="small"> le leader dans ce domaine </em></h3></div>
