<?php
    $imgs=App::getInstance()->getTable('Medias')->servicesmedias('pano');
    $conts=App::getInstance()->getTable('Contenus')->contenupage('pano');
    $bans=App::getInstance()->getTable('Banniere')->BanAll('pano');
?>

  </div>
    <div class="container">
    <div class="row text-center"><h3 style="color:#01B3C5; margin-top:180px; font-variant: small-caps;">Pano Mobile <em class="small"> le leader dans ce domaine </em></h3></div>
